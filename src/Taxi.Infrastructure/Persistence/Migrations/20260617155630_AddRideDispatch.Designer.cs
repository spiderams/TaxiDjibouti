...
namespace Taxi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260617155630_AddRideDispatch")]
    partial class AddRideDispatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taxi.Domain.Drivers.Driver", b =>
                {
                    ...
                    b.HasIndex("LastLocation")
                        .HasDatabaseName("ix_drivers_last_location");
            ...
            modelBuilder.Entity("Taxi.Domain.Rides.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("DriverId")
                        .HasDatabaseName("ix_ratings_driver_id");

                    b.HasIndex("RideId")
                        .IsUnique()
                        .HasDatabaseName("ix_ratings_ride_id");

                    b.ToTable("ratings", (string)null);
                });

            modelBuilder.Entity("Taxi.Domain.Rides.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("RideId")
                        .HasDatabaseName("ix_reports_ride_id");
            ...
            modelBuilder.Entity("Taxi.Domain.Rides.Ride", b =>
                {
                    ...
                    b.Property<string>("DestinationZone")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("destination_zone");
                    ...
                    b.PrimitiveCollection<List<int>>("TriedDriverIds")
                        .IsRequired()
                        .HasColumnType("integer[]")
